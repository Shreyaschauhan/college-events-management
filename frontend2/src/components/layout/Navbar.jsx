...
const Navbar = () => {
  // State and Hooks are identical to TSX
  const { user, isAuthenticated, logout, hasRole } = useAuth();
  const navigate = useNavigate();
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  // Helper functions are identical to TSX
  ...
  // JSX structure, classes, and logic are identical to TSX
  return (
              ...
              <DropdownMenu>
                  ...
                  <Button variant="ghost" className="gap-2 px-2">
                    {user?.profileImage ? (
                      <img
                        ...
                        alt={user.name} // Note: alt should ideally be descriptive, user.name is okay here
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <div className="flex flex-col space-y-1 p-2">
                    ...
                    {/* Added optional chaining for safety, though useAuth should guarantee user if authenticated */}
